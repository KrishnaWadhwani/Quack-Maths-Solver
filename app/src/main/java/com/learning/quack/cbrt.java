...
public class cbrt extends AppCompatActivity {
    ...
    public void cbrt(View view){
        ...
        if (inputstr.matches("")){
            ...
            ans.setText("∛: "+Math.cbrt(finalvalue));
    ...
    public void share(View view){
        ...
        sendIntent.putExtra(Intent.EXTRA_TEXT, "∛ Cube Root Of "+finalvalue+" = "+Math.cbrt(finalvalue)+" Answer By Quack Maths Homework Solver, Download Quack Maths Homework Solver Now https://play.google.com/store/apps/details?id=com.learning.quack");
